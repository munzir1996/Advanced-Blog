...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', 'Sucessfully created the '. $role->display_name . ' role in the database');
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('success', 'Sucessfully update the '. $role->display_name . ' role in the database');
